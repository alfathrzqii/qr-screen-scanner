...
import dev.alfathrzqii.qrscreenscanner.scanner.QrCodeAnalyzer
import dev.alfathrzqii.qrscreenscanner.scanner.ScreenCaptureManager
...
class MediaProjectionService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Enter foreground immediately with mediaProjection type
        ...
        // Obtain projection and capture while running in foreground
        serviceScope.launch {
            try {
